...
If certain information in the text does not fit predefined categories, create new keys as necessary. If specific details are missing or incomplete in the text, mark the values as 'NA'. Ensure phone numbers, emails, and names are properly formatted, and replace any placeholder symbols like 'dot' in emails with a period ('.').

The output should be in valid JSON format with appropriate details.
"""
